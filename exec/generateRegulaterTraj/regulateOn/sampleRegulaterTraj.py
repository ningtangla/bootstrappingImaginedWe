...
def main():
    ...
    dirName = os.path.dirname(__file__)
    trajectoriesSaveDirectory = os.path.join(dirName, '..', '..', '..', 'data', 'regulateOn', 'trajectories')
    ...
    if not os.path.isfile(trajectorySavePath):
        ...
        updateIntention = [sheepUpdateIntentionMethod] * (numSheep + 1) + [inferImaginedWe[1]]
	...
	#break Commitment Policy
        ...
        regulateCommitmentBrokens = [None, None, regulateCommitmentBroken, None]
