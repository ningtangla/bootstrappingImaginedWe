...
# mcts demo
        ...
        wolfCentralControlGuidedMCTSPolicyGivenIntention = MCTS(numSimulationsWolf, selectChild, expandWolf, estimateValueWolf, backup, establishPlainActionDist, mctsRenderWolf, mctsRenderOn)
        numSimulationsSheep = 20
        sheepCentralControlGuidedMCTSPolicyGivenIntention = MCTS(numSimulationsSheep, selectChild, expandSheep, estimateValueSheep, backup, establishPlainActionDist, mctsRenderSheep, mctsRenderOn)
