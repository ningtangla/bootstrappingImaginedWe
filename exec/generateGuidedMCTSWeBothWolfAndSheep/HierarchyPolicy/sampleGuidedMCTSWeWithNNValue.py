...
def main():
    ...
    dirName = os.path.dirname(__file__)
    trajectoriesSaveDirectory = os.path.join(dirName, '..', '..', '..', 'data', 'generateGuidedMCTSWeWithNNValueBothWolfSheep', 'HierarchyPolicy', 'trajectories')
	...
	# MCTS
        ...
        wolfLevel2GuidedMCTSPolicyGivenIntention = MCTS(numSimulationsWolf, selectChild, expandWolf, estimateValueWolf, backup, establishPlainActionDist)
